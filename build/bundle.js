...
exports.default = [{ path: "/", component: _Home2.default, exact: true }, { loadData: _UsersList.loadData, path: "/users", component: _UsersList2.default }];
...
function loadData() {
  console.log("I am loading some data...");
}
